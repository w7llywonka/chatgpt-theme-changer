...
const SOUND_IDS = new Set(["soft", "glass", "pulse"]);
...
function normalizeTheme(input = {}) {
  ...
  return {
    ...
    soundId: SOUND_IDS.has(merged.soundId) ? merged.soundId : DEFAULT_THEME.soundId,
...
:root {
  ...
  --theme-studio-ui-font: ${JSON.stringify(theme.uiFont)}, "Segoe UI", sans-serif;
